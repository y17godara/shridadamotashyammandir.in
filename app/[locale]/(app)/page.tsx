            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex mt-6 flex-col items-start justify-start text-start gap-0.5 text-pretty">
                <p className="text-sm lg:text-base font-semibold">
                  Shri Shyam Shri Dada Mote Ji Mandir is a Hindu temple
                  dedicated to Lord Krishna and is located in Bharthal Village,
                  Dwarka Sector 26, New Delhi. The temple is a divine place
                  where you can seek blessings of Lord Krishna and others.{" "}
